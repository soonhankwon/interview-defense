...
public final class PromptGenerator {
    ...
    public static final String INIT_DEFENSE_ROLE = " 프로그래밍 전문가입니다.";
    public static final String INIT_DEFENSE_ROLE_KOREAN = "그리고 IT 기업 한국인 면접관입니다.";
    public static final String INIT_DEFENSE_LIMITED = "질문은 1개만 해주세요.";
    public static final String INIT_DEFENSE_USER_HELLO = "안녕하세요 저는 ";
    public static final String INIT_DEFENSE_USER_QUESTION = "기술 스택을 가지고 있습니다. 기술 면접을 시작해주세요";
    public static final String DEFENSE_CHARACTER = "당신은 질문을 명확하게 하며 답변이 부족하다면 꼬리질문을 하는";
    public static final String DEFENSE_ROLE = " 프로그래밍 전문가 입니다.";
    ...
    public static final String DEFENSE_ROLE_QUESTION_OPTION = "기술면접에서 중요한 다양한 질문을 해주세요.";
    public static final String DEFENSE_OPTION_SCORE = "답변에 대한 정확도 점수를 [점수: 0~100] 로 평가해서 표시해주세요.";
    public static final String DEFENSE_OPTION_ROLE_SCORE = "답변의 명확성 및 정확도를 간단히 평가해주시고 점수를 평가해주세요.";
    public static final String DEFENSE_OPTION_SCORE_UNNATURAL = "면접 상황에 부자연스러운 답변을 받는다면 다른 질문을 해주세요. 이경우 점수는0 입니다.";
    public static final String DEFENSE_OPTION_SCORE_SHORT = "단답형 답변에 대해서는 꼬리질문을 해주세요. 이경우 점수는50 입니다.";
    public static final String DEFENSE_OPTION_SCORE_DONT_KNOW = "모르겠다는 답변에 대해서는 다른 질문을 해주세요. 이경우 점수는30 입니다.";
    public static final String DEFENSE_OPTION_SCORE_GREAT = "점수가 80이상이라면 다른 주제의 질문을 합니다.";
    public static final String DEFENSE_OPTION_SCORE_BAD = "점수가 80미만이라면 꼬리질문을합니다.";
