...
public enum CustomErrorCode {
    ...
    NOT_EXISTS_TECH_BY_USER("유저의 기술스택 정보가 없습니다."),
    ALREADY_EXISTS_TECH_BY_USER("이미 유저의 기술스택이 추가되어 있습니다."),
    NOT_EXISTS_LANGUAGE_BY_USER("유저의 언어 정보가 없습니다."),
    ALREADY_EXISTS_LANGUAGE_BY_USER("이미 유저의 언어가 추가되어 있습니다.");
